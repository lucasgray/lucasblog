...
Advent is a Pixel Tactical RPG, which means it's very important to us that the game map evokes the classic feel of old Game Boy Advance Fire Emblem games. There was something magical about playing a strategy game on a handheld for the first time, nothing quite as sophisticated as Starcraft but the characters were entertaining and the pixel art storyline was top notch.

I had implemented a rudimentary map combat system, and animated my character sprites. However, the character idle animations started out 100% synchronized, but over time, they'd slowly drift apart, every character marching to their own drum. Especially as a big fan of rhythm games, this insubordination cannot stand!
...
The problem is that the characters walk to new positions, then we re-play their idle animations afterwards. The characters walk at a different and variable cadence depending on the length of their journey (and, sometimes I do vary the speed). With some details left out, the move code looks like this:
...
This resulted in the cacophony I mentioned earlier, with every character clearly disrespecting the rules of the TRPG. What absolute insolence. Although, it looks like they're having fun. Who can really blame them.
